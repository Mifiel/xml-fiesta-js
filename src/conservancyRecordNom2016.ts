...
import { b64toHex, parseDate, hextoAscii, sha256hex } from "./common";
...
export default class ConservancyRecordNom2016 {
  ...
  constructor(
    ...
    if (!this.record) {
      throw new ArgumentError("Conservancy must have record");
    }
  ...
  rootCertificateHex() {
    const ar_pos = ASN1HEX.getPosArrayOfChildren_AtObj(
      this.certificatesHex(),
      0,
    );
    return ASN1HEX.getHexOfTLV_AtObj(this.certificatesHex(), ar_pos[1]);
  }
  ...
  caCertificateHex() {
    ...
    return ASN1HEX.getHexOfTLV_AtObj(this.certificatesHex(), ar_pos[0]);
  }
  ...
  certificatesHex() {
    ...
    return ASN1HEX.getHexOfTLV_AtObj(this.archiveHex(), ar_pos[3]);
  }
  ...
  messageDigest() {
    ...
    let ar_pos = ASN1HEX.getPosArrayOfChildren_AtObj(pkcs9, 0);
    ar_pos = ASN1HEX.getPosArrayOfChildren_AtObj(pkcs9, ar_pos[2]);
    ar_pos = ASN1HEX.getPosArrayOfChildren_AtObj(pkcs9, ar_pos[1]);
    return ASN1HEX.getHexOfV_AtObj(pkcs9, ar_pos[0]);
  }
  ...
  signedTimeStamp() {
    ...
    ar_pos = ASN1HEX.getPosArrayOfChildren_AtObj(pkcs9, ar_pos[1]);
    ar_pos = ASN1HEX.getPosArrayOfChildren_AtObj(pkcs9, ar_pos[1]);
    const date = ASN1HEX.getHexOfV_AtObj(pkcs9, ar_pos[0]);
  ...
  signingCertificateV2() {
    const pkcs9 = this.signedAttributesHex();
    let ar_pos = ASN1HEX.getPosArrayOfChildren_AtObj(pkcs9, 0);
    ar_pos = ASN1HEX.getPosArrayOfChildren_AtObj(pkcs9, ar_pos[3]);
    ar_pos = ASN1HEX.getPosArrayOfChildren_AtObj(pkcs9, ar_pos[1]);
    ar_pos = ASN1HEX.getPosArrayOfChildren_AtObj(pkcs9, ar_pos[0]);
    ar_pos = ASN1HEX.getPosArrayOfChildren_AtObj(pkcs9, ar_pos[0]);
    ar_pos = ASN1HEX.getPosArrayOfChildren_AtObj(pkcs9, ar_pos[0]);
    return ASN1HEX.getHexOfV_AtObj(pkcs9, ar_pos[1]);
  }
  ...
  tSTInfoHex() {
    ...
    ar_pos = ASN1HEX.getPosArrayOfChildren_AtObj(this.archiveHex(), ar_pos[1]);
    ar_pos = ASN1HEX.getPosArrayOfChildren_AtObj(this.archiveHex(), ar_pos[0]);
    ar_pos = ASN1HEX.getPosArrayOfChildren_AtObj(this.archiveHex(), ar_pos[2]);
    ar_pos = ASN1HEX.getPosArrayOfChildren_AtObj(this.archiveHex(), ar_pos[1]);
    ar_pos = ASN1HEX.getPosArrayOfChildren_AtObj(this.archiveHex(), ar_pos[0]);
    return ASN1HEX.getHexOfTLV_AtObj(this.archiveHex(), ar_pos[0]);
  }
  ...
  contentAttributesHex() {
    ...
    ar_pos = ASN1HEX.getPosArrayOfChildren_AtObj(this.archiveHex(), ar_pos[1]);
    ar_pos = ASN1HEX.getPosArrayOfChildren_AtObj(this.archiveHex(), ar_pos[0]);
    return ASN1HEX.getHexOfTLV_AtObj(this.archiveHex(), ar_pos[4]);
  }
  ...
  signedAttributesHex() {
    ...
    ar_pos = ASN1HEX.getPosArrayOfChildren_AtObj(this.archiveHex(), ar_pos[1]);
    ar_pos = ASN1HEX.getPosArrayOfChildren_AtObj(this.archiveHex(), ar_pos[0]);
    ar_pos = ASN1HEX.getPosArrayOfChildren_AtObj(this.archiveHex(), ar_pos[4]);
    ar_pos = ASN1HEX.getPosArrayOfChildren_AtObj(this.archiveHex(), ar_pos[0]);
    let hex = ASN1HEX.getHexOfTLV_AtObj(this.archiveHex(), ar_pos[3]);
  ...
  archiveSignature() {
    ...
    let ar_pos = ASN1HEX.getPosArrayOfChildren_AtObj(info, 0);
    ar_pos = ASN1HEX.getPosArrayOfChildren_AtObj(info, ar_pos[0]);
    return ASN1HEX.getHexOfV_AtObj(info, ar_pos[5]);
  }

  archiveSignedHash() {
    const tSTInfo = this.tSTInfoHex();
    let ar_pos = ASN1HEX.getPosArrayOfChildren_AtObj(tSTInfo, 0);
    ar_pos = ASN1HEX.getPosArrayOfChildren_AtObj(tSTInfo, ar_pos[2]);
    return ASN1HEX.getHexOfV_AtObj(tSTInfo, ar_pos[1]);
  }
  ...
  validArchiveHash() {
    ...
    if (!this.signingCertificateV2()) {
      console.error(
        "conservancyRecordNom2016: Signing certificate V2 is not valid",
      );
      return false;
    }
  ...
  recordTimestamp() {
    const ts_pos = ASN1HEX.getPosArrayOfChildren_AtObj(this.tSTInfoHex(), 0);
    const date = ASN1HEX.getHexOfV_AtObj(this.tSTInfoHex(), ts_pos[4]);
    return parseDate(hextoAscii(date));
  }
