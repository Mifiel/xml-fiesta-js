  ...
  describe("instance", function () {
    describe("when the provided string is not a certificate", function () {
      it("should have an error", () => {
        expect(() => new Certificate("")).to.throw(
      ...
      it("should have an error", () => {
        ...
        ).to.throw("The certificate is not valid.");
      });
    });
    ...
    describe("when provide a hex string", () => {
      it("should have no errors", () => {
        expect(
          () => new Certificate(null, certificatesAndKeys.FIELCer),
        ).not.to.throw();
      });
    });
    ...
    describe("getSerialNumberHex", () =>
      it("should not be null", () =>
        expect(fielCertificate.getSerialNumber()).to.equal(
          "20001000000200001410",
        )));
    ...
    describe("isCa", function () {
      ...
      beforeEach(function () {
        ...
        cert = fs.readFileSync(
          `${__dirname}/fixtures/production-certificate.cer`,
        );
      ...
      describe("when no a CA", () =>
        it("should be false", function () {
          intermediate = fs
            .readFileSync(`${__dirname}/../docs/AC1_Sat.crt`)
            .toString();
      ...
      describe("when CA is not CA", () =>
        it("should be false", function () {
          cert = fs.readFileSync(
            `${__dirname}/fixtures/production-certificate.pem`,
          );
